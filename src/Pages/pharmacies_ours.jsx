...
const partnerLogos = [
  { name: "النهدي", img: "/imges/PharmcyLogo/02_pharmaoverseas.png" },
...
export function PharmacyOurs() {
  ...
  const handleSearchSubmit = (e) => {
    ...
    const hasMatchingPharmacy = pharmacies.some(
      (p) =>
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center justify-around border-t border-slate-100 pt-3.5 text-slate-400">
              <div
                className={`flex flex-col items-center gap-1 cursor-help transition-all ${pharmacy.hasDelivery ? "text-[#1ab5ea]" : "opacity-25 filter grayscale"}`}
              ...
              <div
                className={`flex flex-col items-center gap-1 cursor-help transition-all ${pharmacy.is24h ? "text-[#1ab5ea]" : "opacity-25 filter grayscale"}`}
              ...
              <div
                className={`flex flex-col items-center gap-1 cursor-help transition-all ${pharmacy.hasParking ? "text-[#1ab5ea]" : "opacity-25 filter grayscale"}`}
