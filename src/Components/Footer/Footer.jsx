        ...
        {/* <footer className="bg-neutral-primary-soft">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <NavLink to="https://flowbite.com/" className="flex items-center">
                            <img src={logo} className="w-60 me-3" alt="Logo" />
                        </NavLink>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-body sm:text-center">© 2023 <NavLink to="https://flowbite.com/" className="hover:underline">Flowbite™</NavLink>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 sm:justify-center sm:mt-0">
                        <NavLink to="#" className="text-body hover:text-heading">
                        ...
                        <NavLink to="#" className="text-body hover:text-heading ms-5">
