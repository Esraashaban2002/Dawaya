          ...
          <div className="order-2 lg:order-1 lg:w-[38%] flex flex-col gap-6">
            <div className="bg-white rounded-[30px] p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">رفع الروشتة</h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-6">قم بمسح وإرسال روشتة الطبية بسرعة لصرفها بشكل موثوق</p>
                <label className="px-6 py-3 bg-blue-600 text-white rounded-full text-sm font-semibold hover:bg-blue-700 transition-all duration-300 shadow-md cursor-pointer inline-block">
                  اختر ملف
            ...
            <div className="bg-white rounded-[30px] p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">تذكيرات واتساب</h3>
                ...
                <button className="px-6 py-3 bg-green-600 text-white rounded-full text-sm font-semibold hover:bg-green-700 transition-all duration-300 shadow-md">تفعيل الآن</button>
              </div>
            </div>
          </div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      <div className="flex flex-wrap gap-4 justify-end pt-6">
                        <button className="px-8 py-3.5 bg-gradient-to-l from-blue-600 to-blue-700 text-white rounded-full font-bold text-sm hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 shadow-lg">
                          اطلب الآن
                        </button>
                        <button className="px-8 py-3.5 bg-white/10 backdrop-blur-md text-white rounded-full font-bold text-sm border-2 border-white/40 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                          اعرف المزيد
                        </button>
                      </div>
                    </motion.div>
