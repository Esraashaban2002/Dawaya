            ...
            <nav className="bg-neutral-primary">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    ...
                    <div className="flex items-center space-x-6 rtl:space-x-reverse">
                        <NavLink to="/regester" className="text-sm font-medium pl-5 hover:underline" >إنشاء حساب</NavLink>
                        <NavLink to="/login" className="text-sm font-medium text-fg-brand hover:underline" >تسجيل الدخول</NavLink>
                    </div>
                ...
                <div className="max-w-screen-xl px-4 py-3 mx-auto">
                    <div className="flex items-center">
                        <ul className="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                            <li>
                                <NavLink to="/" className="text-heading hover:underline" aria-current="page" >الرئيسيه</NavLink>
                            </li>
                            <li>
                                <NavLink to="/about" className="text-heading hover:underline">من نحن </NavLink>
                            </li>
                            <li>
                                <NavLink to="" className="text-heading hover:underline">الصيدليات</NavLink>
                            </li>
                            <li>
                                <NavLink to="" className="text-heading hover:underline">خدمات </NavLink>
                            </li>
                        </ul>
                    </div>
                </div>
